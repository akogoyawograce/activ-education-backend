package tg.edtch.activEducation.horsligne.domain.entite;
...
public class SyncLog extends BaseEntity {
    ...
    @Column(name = "type_donnees", length = 50) private String typeDonnees;
    @Column(name = "taille_kb") private Integer tailleKb;
    @Column(name = "derniere_sync") @Builder.Default private java.time.LocalDateTime derniereSync = java.time.LocalDateTime.now();
