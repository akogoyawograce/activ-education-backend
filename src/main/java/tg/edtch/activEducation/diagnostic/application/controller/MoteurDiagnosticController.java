...
@org.springframework.security.access.prepost.PreAuthorize("hasAnyRole('ELEVE', 'ADMIN')")
...
public class MoteurDiagnosticController {
        ...
        public ResponseEntity<ResultatDiagnosticResponse> diagnosticCombine(
                ...
                ResultatDiagnosticResponse response = moteurDiagnosticService.diagnosticCombine(eleveTrackingId,
                                quizTrackingId,
                                reponsesTrackingIds);
                return ResponseEntity.ok(response);
        }
        ...
        public ResponseEntity<QuestionResponse> determinerProchaineQuestion(
                        @PathVariable UUID quizTrackingId,
                        @PathVariable UUID reponseTrackingId,
                        @PathVariable UUID eleveTrackingId) {

                QuestionResponse response = moteurDiagnosticService
        ...
        public ResponseEntity<List<QuestionResponse>> getQuestionsFiltrees(
                        @PathVariable UUID quizTrackingId,
                        @PathVariable UUID eleveTrackingId) {

                List<QuestionResponse> response = moteurDiagnosticService
